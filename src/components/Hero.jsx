    ...
    <section id="inicio" className="pt-24 pb-12 px-4 bg-gray-100">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a href="public/StefanoP-CV.pdf" target="_blank" rel="noopener noreferrer" className="border border-gray-400 text-gray-700 px-6 py-3 rounded-lg hover:border-blue-500 hover:text-blue-500 transition duration-300">
          {t.btnCV}
          </a>
        </div>
      </div>
